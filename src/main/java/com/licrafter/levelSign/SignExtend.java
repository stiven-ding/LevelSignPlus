...
public class SignExtend extends JavaPlugin {
    ...
    public void onEnable() {
        getLogger().info("Enabling SignExtend (版本:" + getDescription().getVersion() + " "
                + "作者:" + getDescription().getAuthors().get(0) + " )" + " WebSite:" + getDescription().getWebsite());
        if (setupEconomy()) {
    ...
    private void initHolder() {
        ...
        new Holder(this, "[ONE]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getString("rank.one", "暂无"));
            }
        };
        new Holder(this, "[TWO]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getString("rank.two", "暂无"));
            }
        };
        new Holder(this, "[THREE]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getString("rank.three", "暂无"));
            }
        };
        ...
        new Holder(this, "[COUNT1]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getInt("count.one") + "只");
            }
        };
        ...
        new Holder(this, "[COUNT2]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getInt("count.two") + "只");
            }
        };
        ...
        new Holder(this, "[COUNT3]", "sign.create") {
            ...
            public String getValue(Player var1, Location var2, String var3) {
                return ChatColor.translateAlternateColorCodes('&'
                        , "&a&l" + mobConfig.getInt("count.three") + "只");
            }
        };
    }
